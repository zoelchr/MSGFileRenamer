...
echo python msg_file_renamer.py --no_test_run --set_filedate --search_directory "%ZIELPFAD%" --excel_log_directory "./"
python "msg_file_renamer.py" --no_test_run  --search_directory "%ZIELPFAD%" --excel_log_directory "./"
