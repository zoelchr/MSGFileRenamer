...
echo       - Zeitstempel MSG-Datei ändern
echo       - PDF-Erzeugung inkl. Überschreiben
...
echo python msg_file_renamer.py --no_test_run --set_filedate --generate_pdf  --search_directory "%ZIELPFAD%" --excel_log_directory "./"
python "msg_file_renamer.py" --no_test_run --set_filedate --generate_pdf --search_directory "%ZIELPFAD%" --excel_log_directory "./"
